    ...
    <>
      ...
      <div className="relative h-full w-full">
        ...
        <div className="flex h-full max-h-[calc(100%-56px)] w-full">
          <Sidebar>
            <Sidebar.Link href={route("home")} icon="bi bi-house">
              Home
            </Sidebar.Link>
            <Sidebar.Link href={route("appointment.home")} icon="bi bi-people">
              Appointment
            </Sidebar.Link>
            <Sidebar.Link href={route("blog.home")} icon="bi bi-newspaper">
              Blog
            </Sidebar.Link>
            <Sidebar.Link href={route("journal.home")} icon="bi bi-book">
              Journal
            </Sidebar.Link>
            <Sidebar.Link href={route("points.home")} icon="bi bi-star">
              Points
            </Sidebar.Link>
          </Sidebar>
